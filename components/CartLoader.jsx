  ...
  return (
    <div className="w-[158px] h-[247px] lg:w-[213px] lg:h-[331px] border-[1px] border-slate-100 rounded-xl shadow-md relative cursor-pointer">
      <div className="animate-pulse">
        <div className="w-[134px] h-[173px] mx-[auto] mt-[12px] lg:w-[183px] lg:h-[243px] lg:mt-[20px] rounded-lg">
        ...
        <div
          className="border-2 rounded-md  w-[134px] h-[32px] mx-auto mt-[12px] bg-slate-200 
      lg:w-[183px] lg:h-[30px] lg:mt-[18px] text-center py-1"
        ></div>
      </div>
    </div>
  );
