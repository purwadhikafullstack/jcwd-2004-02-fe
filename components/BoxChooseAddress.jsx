        ...
        <div className=" h-[150px] flex flex-col rounded-lg shadow-md p-3"> 
            <div className="mb-7">
                <div className="flex justify-between">
                    ...
                    <button disabled={terpilih} onClick={defaultAddress} className={`${terpilih?'bg-slate-500':'bg-purple-900'} ` +"w-[100px] h-[30px]  text-white rounded-lg text-xs"}>{terpilih?'terpilih': 'Pilih'}</button>
                </div>
            </div> 
