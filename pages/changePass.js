    ...
    <>
      ...
      <div className="flex px-0 mt-20">
        ...
        <div className="px-8 xl:w-1/2 xl:h-screen xl:px-20 xl:pt-10">
          <div className="mt-20 flex flex-col xl:mt-3 mb-5 text-2xl text-purple-900">
            <div>
              Change Password
          ...
          <div>
            <form onSubmit={formik.handleSubmit}>
              <div className="flex flex-col relative mb-4 xl:mb-2">
                ...
                <div
                  className="absolute xl:bottom-3 top-8 ml-[278px] xl:ml-[500px] text-purple-800 text-lg"
