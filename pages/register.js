        ...
        <div className="flex">
            ...
            <div className="px-8 xl:w-1/2 xl:h-screen xl:px-20 xl:pt-10">  
                <div className="mt-20 flex flex-col xl:mt-3"> 
                    <div>
                        <span className="font-bold inline-block xl:hidden text-2xl xl:text-2xl">Register</span> 
                ...
                <div className="mt-8 xl:mt-5 flex justify-between"> 
                    <ButtonSecondary className="w-36 xl:w-56 xl:h-10 h-12 flex items-center justify-center border-gray-400 font-bold"><FcGoogle className="mr-2 text-2xl xl:text-xl"/>Google</ButtonSecondary>
                    <ButtonPrimary className="w-36 xl:w-56 flex items-center justify-center bg-blue-500 font-bold"><BsFacebook className="mr-2 text-2xl xl:text-xl"/>Facebook</ButtonPrimary>
                </div>
                ...
                <div>
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <div className="mt-5 mb-16 xl:mb-9 xl:mt-7">
                            ...
                            <span className="text-xs xl:text-sm font-light">Saya setuju dengan persyaratan dan ketentuan</span>
                        </div>
                        <div>
                            <ButtonPrimary type="submit" className="w-full h-12 xl:h-10">Register</ButtonPrimary>
                        </div>
                    </form>
                </div>
