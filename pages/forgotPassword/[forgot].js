        ...
        <div className="flex">
            ...
            <div className="px-8 xl:w-1/2 xl:h-screen xl:px-20 xl:pt-10">  
                <div className="mt-20 flex flex-col xl:mt-3"> 
                    <div>
                        <span className="font-bold text-2xl xl:text-2xl">Lupa Kata Sandi</span> 
                    </div>
                </div> 
                <div className="mt-8">
                    <form onSubmit={formik.handleSubmit}>
                        <div className="flex flex-col relative mb-4 xl:mb-4">
                            ...
                            <input name="newPassword" type={show2 ? 'text':'password'} placeholder="Masukkan password baru anda" className="border-2 xl:h-10 h-12 pl-8 pb-1 w-full xl:pl-10 rounded-xl focus:outline-none xl:text-sm" onChange={formik.handleChange} value={formik.values.newPassword} onBlur={formik.handleBlur} required></input>
                        ...
                        <div>
                            <ButtonPrimary type="submit" className="w-full h-12 xl:h-10">Reset Password</ButtonPrimary>
                        </div>
                    </form>
                </div>
                <div className="mt-8 xl:flex xl:items-center xl:justify-center ">
                    <span className="xl:text-sm">Belum Punya Akun?</span><span className="text-purple-800 xl:text-sm font-semibold xl:ml-1 cursor-pointer">Daftar</span>
                </div>
            </div>
        </div>
