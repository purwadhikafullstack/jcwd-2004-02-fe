...
import Link from "next/link";
import { useRouter, router } from "next/router";
>>>>>>> ce84d6244f78e66c88c1f677c3050256c5fc63b8
        ...
        <div className="flex">
            ...
            <div className="px-8 xl:w-[720px] xl:h-screen xl:px-20 xl:pt-10">  
                ...
                <div className="mt-8">
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <div className="flex flex-col relative">
                            ...
                            <div className="absolute xl:bottom-3 top-8 ml-[278px] xl:ml-[490px] text-purple-800 text-lg" onClick={handleClick1}>{show1?<BsEyeFill/>:<BsEyeSlashFill/>}</div>
                        </div>
                        <div className="mt-5 mb-16 xl:mb-9 xl:mt-1 flex xl:items-center xl:justify-center">
                            ...
                            <div className="w-full flex items-center justify-between">
                                ...
                                <Link href={"/forgotPassword"}>
                                    <span className="text-xs xl:text-sm font-extralight text-gray-400 cursor-pointer">Lupa Kata Sandi?</span>
                                </Link>
                            </div>
                        </div>
                        <div>
                ...
                <div className="mt-8 xl:flex xl:items-center xl:justify-center ">
                    <span className="xl:text-sm">Belum Punya Akun?</span><Link href={"/register"}><span className="text-purple-800 xl:text-sm font-semibold xl:ml-1 cursor-pointer">Daftar</span></Link>
                </div>
            </div>
=======
  if (isLogin && role_id == 0) {
