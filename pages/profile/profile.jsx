...
const Profile = () => {
  ...
  return (
    ...
    <div className="flex col shadow-purple-200 shadow-2xl h-5/6 rounded-lg mt-10 py-20 mx-48 justify-center ">
      <div>
        <div className=" bg-red-400 pt-10 ml-11 text-4xl font-bold">Profil</div>
