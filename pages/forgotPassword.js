                ...
                <div className="mt-8">
                    <form onSubmit={onSendForgotPass}>
                        <div className="flex flex-col relative mb-4 xl:mb-8">
                            ...
                            <input name="email" placeholder="Masukkan email anda" className="border-2 xl:h-10 h-12 pl-8 pb-1 w-full xl:pl-10 rounded-xl focus:outline-none xl:text-sm" onChange={handleInput} ></input>
                            <div className="absolute xl:bottom-3 bottom-4 ml-3 text-purple-800 text-lg"><MdEmail/></div>
                        </div> 
                        <div>
                            <ButtonPrimary type="submit" className="w-full h-12 xl:h-10">Kirim Email</ButtonPrimary>
                        </div>
                    </form>
                </div>
